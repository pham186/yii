...
class ModelCode extends CCodeModel
{
	...
	public function prepare()
	{
		...
		foreach($tables as $table)
		{
			...
			// bihn thuong no se gen ra 1 file
			// minh add them 1 file no gen ra trong thu muc base
			// khi gen ra no se chon template file de gen ra code
			// cai model tren minh se dung template $templatePath.'/model.php'
			// cai duoi minh dung tempalte $templatePath.'/modelBase.php'
			// minh se tao va sua 2 tempalte nay, cai base minh ko can sua sua cai model thoi
			$this->files[]=new CCodeFile(
